...
const EnhancedMetricCard: React.FC<EnhancedMetricCardProps> = ({ metric, onClick }) => {
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        ...
        <div className={`w-12 h-12 rounded-lg flex items-center justify-center border ${colorClasses[metric.color]}`}>
