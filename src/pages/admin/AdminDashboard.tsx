...
import { getStats, getTopCompanies } from "../../api/company";
...
const AdminDashboard: React.FC = () => {
  ...
  const [industryDistribution] = useState<IndustryData[]>([
    {
      name: "Tecnologia",
      value: 18,
      color: "#d83dff",
  ...
  useEffect(() => {
    ...
    const getAllTopCompanies = async () => {
        ...
        <div className="bg-secondary border border-tertiary rounded-lg p-4 shadow-xl">
          ...
          {payload.map((entry: any, index: number) => (
            <p key={index} style={{ color: entry.color }}>
              {`${
                entry.dataKey === "companies"
                  ? "Empresas"
                  : entry.dataKey === "employees"
                  ? "Funcionários"
                  : "Emails"
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">
            Visão geral completa da plataforma LeakGuard
          </p>
        </div>
              ...
              <div className="flex items-center space-x-2">
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-sm font-medium text-green-400">
                    +
                    {getGrowthPercentage(
                      currentMonth.companies,
                      previousMonth.companies
                    )}
                    %
                  </span>
                </div>
        ...
        <div className="bg-secondary rounded-xl p-6 border border-tertiary">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-white font-medium">
                {stats.avgEmailsPerCompany.toLocaleString()}
              </span>
            </div>
            <div className="flex items-center justify-between">
        ...
        <div className="bg-secondary rounded-xl p-6 border border-tertiary">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-400">
                Evolução de empresas e funcionários ao longo do tempo
              </p>
            </div>
