import { Company, Employee, Settings, DashboardStats, LeakLocation, EmailVolumeData } from '../types';
...
export const mockLeakLocations: LeakLocation[] = [
  { id: '1', country: 'USA', city: 'New York', latitude: 40.7128, longitude: -74.0060, count: 8 },
  { id: '2', country: 'UK', city: 'London', latitude: 51.5074, longitude: -0.1278, count: 5 },
  { id: '3', country: 'Germany', city: 'Berlin', latitude: 52.5200, longitude: 13.4050, count: 4 },
  { id: '4', country: 'Brazil', city: 'São Paulo', latitude: -23.5505, longitude: -46.6333, count: 3 },
  { id: '5', country: 'Japan', city: 'Tokyo', latitude: 35.6762, longitude: 139.6503, count: 3 },
];
