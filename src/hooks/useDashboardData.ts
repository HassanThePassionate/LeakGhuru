...
import { MetricData, ChartData, TableData, FilterOptions } from '../types/dashboard';
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const chartDataPoints: ChartData[] = [
        { id: '1', name: 'Jan', value: 8500, date: '2024-01', category: 'emails' },
        { id: '2', name: 'Fev', value: 9200, date: '2024-02', category: 'emails' },
        { id: '3', name: 'Mar', value: 10100, date: '2024-03', category: 'emails' },
        { id: '4', name: 'Abr', value: 11500, date: '2024-04', category: 'emails' },
        { id: '5', name: 'Mai', value: 12800, date: '2024-05', category: 'emails' },
        { id: '6', name: 'Jun', value: 13200, date: '2024-06', category: 'emails' },
        { id: '7', name: 'Jul', value: 14100, date: '2024-07', category: 'emails' },
        { id: '8', name: 'Ago', value: 15600, date: '2024-08', category: 'emails' },
        { id: '9', name: 'Set', value: 16200, date: '2024-09', category: 'emails' },
        { id: '10', name: 'Out', value: 17800, date: '2024-10', category: 'emails' },
        { id: '11', name: 'Nov', value: 18500, date: '2024-11', category: 'emails' },
        { id: '12', name: 'Dez', value: 19200, date: '2024-12', category: 'emails' }
      ];
      ...
      const tableDataSet: TableData = {
        ...
        columns: [
          ...
          { key: 'severity', title: 'Gravidade', sortable: true, filterable: true, width: '15%' },
          { key: 'location', title: 'Localização', sortable: true, width: '20%' },
          { key: 'status', title: 'Estado', sortable: true, filterable: true, width: '10%' }
        ],
        rows: [
          {
            id: '1',
